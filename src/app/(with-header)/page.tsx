...
import { TextAndImageSlice, TeamGridSlice, VideoBlockSlice, ProductGridSlice, HeroSlice } from "../../../prismicio-types";
...
type SliceType = TeamGridSlice | VideoBlockSlice | TextAndImageSlice | ProductGridSlice | HeroSlice;
